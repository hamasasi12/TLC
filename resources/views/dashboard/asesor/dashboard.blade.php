...
<body>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.addEventListener('scroll', function() {
                    ...
                    if (window.scrollY > 10) {
                        ...
                        navbar.classList.remove('bg-gradient-to-r', 'from-blue-100', 'to-blue-200', 'shadow-md');
                    } else {
    ...
    <section class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <!-- Card 1: Total Tugas -->
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 group border-l-4 border-blue-800">
                <div class="p-6">
                    <div class="flex justify-between">
                        ...
                        <div class="bg-blue-100 p-3 rounded-full text-blue-800 group-hover:bg-blue-800 group-hover:text-white transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 group border-l-4 border-yellow-500">
                <div class="p-6">
                    <div class="flex justify-between">
                        <div>
                        ...
                        <div class="bg-yellow-100 p-3 rounded-full text-yellow-600 group-hover:bg-yellow-500 group-hover:text-white transition-colors animate-pulse">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 group border-l-4 border-green-500">
                <div class="p-6">
                    <div class="flex justify-between">
                        <div>
                        ...
                        <div class="bg-green-100 p-3 rounded-full text-green-600 group-hover:bg-green-500 group-hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Card 4: Total Asesi -->
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 group border-l-4 border-purple-500">
                <div class="p-6">
                    <div class="flex justify-between">
                        <div>
                        ...
                        <div class="bg-purple-100 p-3 rounded-full text-purple-600 group-hover:bg-purple-500 group-hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex space-x-2">
                        <button class="px-3 py-1.5 bg-blue-800 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                            </svg>
                            Export
                        </button>
                        <button class="px-3 py-1.5 border border-gray-300 text-gray-700 text-sm rounded-lg hover:bg-gray-50 transition-colors">
                            Filter
                        </button>
                    </div>
                </div>
                ...
                <div class="relative h-64">
                    ...
                    <div class="ml-8 h-full flex items-end space-x-6">
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            <div class="w-full flex flex-col items-center" style="height: 83.33%">
                                <div class="w-3/4 bg-blue-800 rounded-t-md h-full relative">
                                    <div class="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-blue-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                                        40 Lulus
                                    </div>
                                </div>
                                <div class="w-3/4 bg-yellow-500 rounded-t-md mt-1 h-1/6 relative">
                                    <div class="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                                        5 Tidak Lulus
                                    </div>
                                </div>
                            </div>
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Jan</span>
                        </div>
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            ...
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Feb</span>
                        </div>
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            ...
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Mar</span>
                        </div>
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            ...
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Apr</span>
                        </div>
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            ...
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Mei</span>
                        </div>
                        ...
                        <div class="group flex-1 h-full flex flex-col justify-end items-center">
                            ...
                            <span class="text-xs text-gray-600 font-medium mt-2 group-hover:text-blue-800 transition-colors">Jun</span>
                        </div>
                    </div>
                </div>
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
        <!-- List Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-black border-b-4 border-yellow-500 pb-2 inline-block">List Asesi B & C</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="mt-6 flex justify-center">
                <button
                    class="bg-blue-800 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition duration-200">
                    Lihat Semua Asesi
                </button>
            </div>
        </div>
    ...
    {{-- Riwayat  Aktifitas --}}  
    <section class="relative max-w-7xl mx-auto px-4 py-8"> 
        <h1 class="text-2xl font-bold mb-1 text-black border-b-4 border-yellow-500 pb-2 inline-block">Riwayat Aktivitas</h1>
        ...
        <div class="bg-white mt-6 rounded-lg shadow-md overflow-hidden">
            <div class="flex items-center p-6" style="background-color: #F8C82A;">
                ...
                <div class="ml-auto flex flex-wrap gap-2">
                    ...
                    <button class="px-4 py-2 bg-blue-800 border border-blue-900 rounded-lg text-white font-medium hover:bg-blue-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                    ...
                    <div class="relative">
                        <button class="flex items-center px-4 py-2 bg-blue-800 border border-blue-900 rounded-lg text-white font-medium hover:bg-blue-700">
                    ...
                    <button class="px-4 py-2 bg-blue-800 border border-blue-900 rounded-lg text-white font-medium hover:bg-blue-700 flex items-center">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="py-4 px-6 text-sm">
                                <span class="px-3 py-1 bg-yellow-500 text-white rounded-full text-xs font-medium">Selesai</span>
                            </td>
                        </tr>
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="py-4 px-6 text-sm">
                                <span class="px-3 py-1 bg-blue-800 text-white rounded-full text-xs font-medium">Berhasil</span>
                            </td>
                        </tr>
                        <tr class="hover:bg-blue-50">
            ...
            <div class="flex items-center justify-between p-6">
                ...
                <div class="flex space-x-1">
                    <button class="px-3 py-1 text-sm text-gray-600 border border-gray-300 rounded-md hover:bg-gray-100">
                        Sebelumnya
                    </button>
                    <button class="px-3 py-1 text-sm text-white bg-blue-800 border border-blue-800 rounded-md">
                        1
                    </button>
                    <button class="px-3 py-1 text-sm text-gray-600 border border-gray-300 rounded-md hover:bg-blue-800 hover:text-white">
                        2
                    </button>
                    <button class="px-3 py-1 text-sm text-gray-600 border border-gray-300 rounded-md hover:bg-blue-800 hover:text-white">
                        3
        ...
        <button class="fixed bottom-5 right-5 bg-blue-800 text-white p-3 rounded-full shadow-lg transform transition-all duration-300 hover:bg-blue-700 hover:scale-110 focus:outline-none hidden md:block">
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 bg-white">
        <div class="mb-8 transform transition hover:scale-102 duration-300">
            <h1 class="text-3xl font-bold text-black flex items-center border-b-4 border-yellow-500 pb-2 inline-block">
                Progress Penilaian
            </h1>
        ...
        <div
            ...
            <div class="flex items-center" style="background-color: #F8C82A; margin: -24px; margin-bottom: 16px; padding: 24px;">
                <div class="flex items-center text-gray-800">
    ...
    <section class="max-w-7xl mx-auto p-4">
        <h1 class="text-2xl font-bold text-blue-800 mb-4 border-b-4 border-yellow-500 pb-2 inline-block">Download Nilai</h1>

        <!-- Tabs -->
        <div class="bg-blue-50 rounded-t-lg">
            <div class="flex">
                <button id="tab-individual" class="flex-1 py-4 text-center font-medium bg-blue-800 text-white rounded-t-lg">
                    Nilai Individual
                </button>
        ...
        <div class="bg-white p-6 rounded-b-lg shadow">
            ...
            <div id="view-individual">
                ...
                <div class="flex flex-wrap gap-4 mb-6">
                    <div class="relative">
                        <select class="appearance-none bg-white border border-gray-300 rounded-md py-2 px-4 pr-8 w-56">
                            <option>Semua Kategori</option>
                    ...
                    <div class="flex gap-2 ml-auto">
                        ...
                        <button class="flex items-center px-4 py-2 border border-blue-900 rounded bg-blue-800 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div id="view-laporan" class="hidden">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6">
                    ...
                    <button class="flex items-center gap-2 px-4 py-2 ml-auto bg-blue-800 text-white rounded border border-blue-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" 
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                d="M12 4v16m8-8H4" />
