            ...
            <form method="POST" action="{{ route('asesi.profile.update') }}" id="profileForm" enctype="multipart/form-data">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        <div class="relative">
                            <div class="w-24 h-24 rounded-full bg-gray-100 overflow-hidden border-4 border-white shadow-md">
                                <img id="profileImage" src="{{ asset('storage/' . (auth()->user()->userProfile->profile_image ?? 'assets/images/default-profile.png')) }}" alt="Foto Profil" class="w-full h-full object-cover">
                            </div>
                            <label for="profileInput" class="absolute bottom-0 right-0 bg-white p-2 rounded-full shadow-md cursor-pointer hover:bg-gray-50 transition">
                        ...
                        <div class="text-center md:text-left">
                            <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ auth()->user()->name }}</h3>
                            <p class="text-gray-600 mb-4">{{ auth()->user()->email }}</p>
                            <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Bergabung {{ auth()->user()->created_at->format('M Y') }}</span>
                                <span class="{{ auth()->user()->userProfile ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }} text-xs font-medium px-2.5 py-0.5 rounded-full">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="flex -mb-px">
                            <button type="button" onclick="switchTab('personal')" id="personalTab" class="tab-button active py-4 px-6 text-center border-b-2 font-medium text-sm whitespace-nowrap border-blue-500 text-blue-600">
                                Data Pribadi
                            </button>
                            <button type="button" onclick="switchTab('education')" id="educationTab" class="tab-button py-4 px-6 text-center border-b-2 font-medium text-sm whitespace-nowrap border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                                Pendidikan
                            </button>
                            <button type="button" onclick="switchTab('work')" id="workTab" class="tab-button py-4 px-6 text-center border-b-2 font-medium text-sm whitespace-nowrap border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                                Pekerjaan
                            </button>
                            <button type="button" onclick="switchTab('address')" id="addressTab" class="tab-button py-4 px-6 text-center border-b-2 font-medium text-sm whitespace-nowrap border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">
                                Alamat
                            </button>
                        </nav>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div id="personalContent" class="tab-content active">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nama_depan" required value="{{ old('nama_depan', auth()->user()->userProfile->nama_depan ?? auth()->user()->name) }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                    @error('nama_depan')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nik" maxlength="16" value="{{ old('nik', auth()->user()->userProfile->nik ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" placeholder="16 digit NIK">
                                    @error('nik')
                                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', auth()->user()->userProfile->tempat_lahir ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Lahir</label>
                                    <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', auth()->user()->userProfile->tanggal_lahir ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Kelamin</label>
                                    <select name="jenis_kelamin" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="L" {{ old('jenis_kelamin', auth()->user()->userProfile->jenis_kelamin ?? '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="P" {{ old('jenis_kelamin', auth()->user()->userProfile->jenis_kelamin ?? '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                </div>
                        ...
                        <div id="educationContent" class="tab-content hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="latar_belakang_pendidikan" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nama_universitas" value="{{ old('nama_universitas', auth()->user()->userProfile->nama_universitas ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" placeholder="Contoh: Universitas Indonesia">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Program Studi</label>
                                    <input type="text" name="program_studi" value="{{ old('program_studi', auth()->user()->userProfile->program_studi ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" placeholder="Contoh: Teknik Informatika">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Tahun Lulus</label>
                                    <select name="tahun_studi" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                        ...
                        <div id="workContent" class="tab-content hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="instansi" id="instansiSelect" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                ...
                                <div id="customInstansiDiv" style="display: {{ old('instansi', auth()->user()->userProfile->instansi ?? '') == 'Lainnya' ? 'block' : 'none' }};">
                                    ...
                                    <input type="text" name="custom_instansi" value="{{ old('custom_instansi', auth()->user()->userProfile->custom_instansi ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" placeholder="Masukkan nama instansi">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Profesi</label>
                                    <input type="text" name="profesi" value="{{ old('profesi', auth()->user()->userProfile->profesi ?? '') }}" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" placeholder="Contoh: Manager, Staff IT, Dokter">
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Lama Masa Kerja</label>
                                    <select name="lama_masa_kerja" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                        ...
                        <div id="addressContent" class="tab-content hidden">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <!-- Provinsi -->
                                <div>
                                    <label for="province" class="block text-sm font-medium text-gray-700 mb-2">Provinsi Domisili <span class="text-red-500">*</span></label>
                                    <select id="province" name="provinsi" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                ...
                                <!-- Kabupaten/Kota -->
                                <div>
                                    <label for="regency" class="block text-sm font-medium text-gray-700 mb-2">Kabupaten/Kota Domisili <span class="text-red-500">*</span></label>
                                    <select id="regency" name="kabupaten" disabled class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                ...
                                <!-- Kecamatan -->
                                <div>
                                    <label for="district" class="block text-sm font-medium text-gray-700 mb-2">Kecamatan Domisili <span class="text-red-500">*</span></label>
                                    <select id="district" name="kecamatan" disabled class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                                ...
                                <!-- Kelurahan -->
                                <div>
                                    <label for="village" class="block text-sm font-medium text-gray-700 mb-2">Kelurahan Domisili <span class="text-red-500">*</span></label>
                                    <select id="village" name="kelurahan" disabled class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium shadow-sm transition duration-200 transform hover:scale-105">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
