        ...
        <div class="max-w-6xl mx-auto">
                    ...
                    <div class="text-center md:text-left flex-grow">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                            ...
                            <div class="bg-gray-50 rounded-lg p-3">
                                ...
                                <div class="font-semibold">{{ auth()->user()->userProfile ? 'Lengkap' : 'Belum Lengkap' }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <form method="POST" action="{{ route('asesi.profile.update') }}" id="profileForm"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-white rounded-3xl shadow-lg p-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Latar Belakang
                                        Pendidikan</label>
                        ...
                        <div class="bg-white rounded-3xl shadow-lg p-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div id="customInstansiDiv"
                                    ...
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Instansi (Jika
                                        Lainnya)</label>
                        ...
                        <div class="bg-white rounded-3xl shadow-lg p-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                                    ...
                                    <span
                                        class="text-sm font-semibold">{{ auth()->user()->updated_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-8 bg-white rounded-3xl shadow-lg p-8">
                    ...
                    <!-- Hidden fields untuk ID (jika diperlukan di masa depan) -->
                    ...
                    <!-- Provinsi -->
                    <div class="mb-6">
                        <label for="province" class="block text-sm font-medium text-gray-700 mb-2">Provinsi Domisili <span
                                class="text-red-500">*</span></label>
                    ...
                    <!-- Kabupaten/Kota -->
                    <div class="mb-6">
                        <label for="regency" class="block text-sm font-medium text-gray-700 mb-2">Kabupaten/Kota Domisili
                    ...
                    <!-- Kecamatan -->
                    <div class="mb-6">
                        <label for="district" class="block text-sm font-medium text-gray-700 mb-2">Kecamatan Domisili
                            <span class="text-red-500">*</span></label>
                    ...
                    <!-- Kelurahan -->
                    <div class="mb-6">
                        <label for="village" class="block text-sm font-medium text-gray-700 mb-2">Kelurahan Domisili
                            <span class="text-red-500">*</span></label>
                    ...
                    <!-- Image Upload -->
                    <div class="flex flex-col sm:flex-row items-start gap-6 p-4 bg-gray-50 rounded-xl">
                        ...
                        <div class="flex-grow">
                            ...
                            <input
                                ...
                                aria-describedby="profile_image_help" name="profile_image" accept=".jpg,.jpeg,.png"
                                id="profileInput" type="file" onchange="previewImage(event)">

                            <div class="mt-1 text-sm text-gray-500" id="profile_image_help">
                ...
                <div class="mt-12 text-center">
                    <button type="submit"
                        class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-2xl shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 font-semibold text-lg transform hover:scale-105">
