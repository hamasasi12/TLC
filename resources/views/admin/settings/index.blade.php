    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="mb-6">
            <a href="{{ url()->previous() }}" class="flex items-center text-blue-600 hover:text-blue-800 transition-colors">
                ...
                <span class="text-xl font-bold">Admin Settings</span>
            </a>
        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 transition-all hover:shadow-md">
                    <div class="p-6">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-6">
                            <div class="relative">
                                <img class="rounded-full w-32 h-32 object-cover border-4 border-gray-100" src="#" alt="Profile picture">
    ...
    <div id="popup" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-50">
        <div class="relative bg-white rounded-xl shadow-xl p-6 w-11/12 md:w-3/5 lg:w-2/5 max-h-[90vh] overflow-y-auto">
            ...
            <div class="flex flex-col items-center">
                <img id="profileImage" src="#" alt="Profile Picture" class="rounded-xl w-full max-h-96 object-cover">
                <div class="mt-4 text-center">
                    <h3 class="text-lg font-semibold text-gray-800">Profile Picture</h3>
                    <p class="mt-2 text-gray-600 text-sm">This is your current profile picture</p>
                </div>
            </div>
        </div>
    </div>
