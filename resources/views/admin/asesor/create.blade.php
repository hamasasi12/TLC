    ...
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white p-6 border-b border-gray-100">
                ...
                <p class="mt-1 text-sm text-gray-500">Isikan semua kolom yang wajib diisi untuk membuat akun Asesor baru</p>
            </div>

            <!-- Form body -->
            <div class="p-6">
                <form action="{{ route('admin.asesor.store') }}" enctype="multipart/form-data" method="POST"
                    class="space-y-6">
                    @csrf
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="name" id="name" required
                                            placeholder="Nama Lengkap Asesor" value="{{ old('name') }}"
                                ...
                                <!-- Berkas CV -->
                                <div>
                                    <label for="berkas_cv" class="block mb-2 text-sm font-medium text-gray-700">
                                        Berkas CV
                                    </label>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        ...
                                        <input type="file" name="berkas_cv" id="berkas_cv" accept=".pdf,.doc,.docx"
                                            class="pr-4 shadow-sm bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full file:bg-blue-600 file:text-white file:border-none file:px-4 file:py-2 file:rounded-l-md file:cursor-pointer file:hover:bg-blue-700 transition">
                                    </div>
                                    <x-input-error :messages="$errors->get('berkas_cv')" class="mt-1 text-xs text-red-500" />
                                </div>


                                <script>
                                    document.getElementById('berkas_cv').addEventListener('change', function(e) {
                                        const fileName = e.target.files[0]?.name || 'Belum ada berkas dipilih';
