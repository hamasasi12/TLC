...
@section('content')
    <div class="max-w-5xl mx-auto px-4 pt-6 mt-4">
        ...
        <div
            ...
            <h1 class="text-xl font-bold text-white sm:text-2xl">Edit Level</h1>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-md overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-white p-6 border-b border-gray-100">
                ...
                <p class="mt-1 text-sm text-gray-500">Isikan semua kolom yang wajib diisi untuk membuat level baru</p>
            </div>
            ...
            <div class="p-6">
                ...
                @endif
                <form action="{{ route('admin.level.update', $level->id) }}" enctype="multipart/form-data" method="POST"
                    class="space-y-6">
                    @csrf
                    @method('put')
