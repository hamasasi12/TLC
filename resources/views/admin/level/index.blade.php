...
@section('content')
        ...
        <nav class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mt-4 text-base">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('admin.level.create') }}" data-popover-target="popover-addUser"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex space-x-2">
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('admin.level.edit', $k->id) }}"
                                    ...
                                    <!-- Delete -->
                                    <form action="{{ route('admin.level.destroy', $k->id) }}" method="POST"
    ...
    <div data-popover id="popover-delete" role="tooltip"
        ...
        <div class="px-3 py-2">
            <p><strong class="text-red-500">Warning!!</strong> Tindakan ini akan menghapus semua level dari sistem.</p>
        </div>
    ...
    <div data-popover id="popover-addUser" role="tooltip"
        ...
        <div class="px-3 py-2">
            <p>Tindakan ini akan menambahkan level baru kedalam database.</p>
        </div>
        <div data-popper-arrow></div>
    </div>
    ...
    <div data-popover id="popover-export" role="tooltip"
        ...
        <div class="px-3 py-2">
            <p>Tindakan ini akan membuat file excel dari data level.</p>
        </div>
        <div data-popper-arrow></div>
    </div>
