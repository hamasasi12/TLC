...
<body>
    ...
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                            id="user-dropdown">
                            <div class="px-4 py-3">
                                <span class="block text-sm text-gray-900 dark:text-white">Yudha Rifqi Ananta</span>
                                <span
                                    class="block text-sm  text-gray-500 truncate dark:text-gray-400">yudha.rifki.ananta@gmail.com</span>
                            </div>
        ...
        <main class="py-8">
            ...
            <div
                class="max-w-screen-xl mx-auto mt-4 bg-white border border-gray-200 rounded-lg shadow-sm p-6 sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Selamat datang Yudha Rifqi Ananta!
                </h5>
                <p class="mb-2 text-base text-gray-500 sm:text-lg dark:text-gray-400">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore dolorem animi porro quos quia
                    quidem
                    et,
                    voluptates voluptate qui vel aliquid dolorum, facere modi odio iste veniam aut, iusto laudantium?
                </p>
            </div>

            <form class="max-w-screen-xl mx-auto mt-4">
                <label for="search"
            ...
            <div class="max-w-screen-xl mx-auto mt-4 mb-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div
                    class="w-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                        <img class="rounded-t-lg bg-auto w-full h-64 object-cover"
                            src="{{ asset('images/levelc.png') }}" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
