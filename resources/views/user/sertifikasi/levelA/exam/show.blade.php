...
@section('content')
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-lg shadow-xl border-b border-[#3A6EA5]/20">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-shrink-0 flex items-center group">
                        <div class="relative">
                            ...
                            <div class="absolute -inset-1 bg-gradient-to-r from-[#3A6EA5] to-[#90BE6D] rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                        </div>
                        <span class="ml-2 text-xl font-bold bg-gradient-to-r from-[#3A6EA5] to-[#90BE6D] bg-clip-text text-transparent hidden sm:block">TLC</span>
                    </div>
                    ...
                    <div class="hidden md:block">
                        <div class="flex items-center space-x-2">
                            <div class="relative overflow-hidden">
                                <span class="relative px-4 py-2 bg-gradient-to-r from-[#3A6EA5] via-[#4A7EBA] to-[#90BE6D] text-white text-sm font-semibold rounded-full shadow-lg">
                                    <span class="relative z-10">Sertifikasi Level A - {{ $category->name ?? 'Tidak ada Kategori' }}</span>
            ...
            <div id="mobileMenu" class="md:hidden hidden border-t border-gray-200/50 py-3 bg-gradient-to-r from-[#3A6EA5]/5 to-[#90BE6D]/5">
                <div class="flex items-center justify-center space-x-2">
                    <span class="text-sm text-gray-600 font-medium">Kategori:</span>
                    <span class="px-3 py-1 bg-gradient-to-r from-[#3A6EA5] to-[#90BE6D] text-white text-sm font-medium rounded-full shadow-md">
    ...
    <div class="min-h-screen py-6 bg-gradient-to-br from-[#3A6EA5]/8 via-purple-50/30 to-[#90BE6D]/8 pt-20">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row lg:justify-between gap-6 h-full">
            ...
            <div class="lg:w-10/12">
                @if ($questions->count() > 0)
                    @php
                        ...
                        $userAnswer = $exam->questionsA()->where('questions_a.id', $question->id)->first()->pivot->user_answer ?? null;
                    @endphp

                    <!-- Enhanced Question Card -->
                    <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden mb-6 border border-[#3A6EA5]/20 h-full relative">
                        <!-- Decorative Elements -->
                        <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#90BE6D]/10 to-transparent rounded-bl-full"></div>
                        <div class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-[#3A6EA5]/10 to-transparent rounded-tr-full"></div>
                        
                        <!-- Enhanced Question Header -->
                        <div class="relative bg-gradient-to-r from-[#3A6EA5] via-[#4A7EBA] to-[#90BE6D] px-6 py-5">
                            <div class="flex justify-between items-center">
                                <h3 class="text-xl font-bold text-white flex items-center">
                                    <span class="bg-white/90 text-[#3A6EA5] rounded-full h-10 w-10 flex items-center justify-center mr-4 font-bold shadow-lg backdrop-blur-sm border border-white/20 text-lg">
                                        {{ $questions->currentPage() }}
                                    </span>
                                    <span class="bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">Pertanyaan</span>
                                </h3>
                        ...
                        <div class="p-8 relative z-10">
                            <div class="prose prose-lg max-w-none mb-8">
                                <div class="relative">
                                    <p class="text-gray-800 text-lg leading-relaxed font-medium bg-gradient-to-r from-gray-50 to-blue-50/30 p-6 rounded-xl border-l-4 border-[#3A6EA5] shadow-sm">
                            ...
                            @if ($question->image)
                                <div class="mb-8 flex justify-center">
                                    <div class="relative group max-w-2xl">
                                        <div class="absolute -inset-2 bg-gradient-to-r from-[#3A6EA5] to-[#90BE6D] rounded-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
                                        ...
                                        <div class="absolute top-2 right-2 bg-black/20 text-white p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        @if ($option)
                                            <div class="group relative">
                                                ...
                                                <label for="answer_{{ $key }}" 
                                                    ...
                                                    <div class="flex items-center justify-center w-8 h-8 rounded-full border-2 border-gray-300 
                                                                peer-checked:border-[#3A6EA5] peer-checked:bg-[#3A6EA5] 
                                                                transition-all duration-200 mr-4 flex-shrink-0">
                                                        <div class="w-4 h-4 rounded-full bg-white opacity-0 peer-checked:opacity-100 transform scale-0 peer-checked:scale-100 transition-all duration-200"></div>
                                                        <span class="absolute text-sm font-bold text-gray-600 peer-checked:text-white transition-colors duration-200">
                                                            {{ strtoupper($key) }}
                                                        </span>
                                                    </div>
                                                    <span class="text-gray-700 peer-checked:text-gray-900 font-medium transition-colors duration-200 flex-1">
                                                        {{ $option }}
                                                    </span>
                                                </label>
                                            </div>
                                    ...
                                    <div class="order-1 sm:order-2 flex gap-4">
                                        @if ($questions->currentPage() < $totalQuestions)
                                            ...
                                            <button type="submit"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2 relative z-10 transition-transform duration-200 group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                                                </svg>
                                            </button>
                                        @else
                                            <input type="hidden" name="next_question" value="{{ $questions->currentPage() }}">
                                            <button type="submit"
            ...
            <div class="lg:w-4/12">
                <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-[#3A6EA5]/20 sticky top-24">
                    <!-- Enhanced Header -->
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-8 gap-2 max-h-80 overflow-y-auto custom-scrollbar p-1">
                            @for ($i = 1; $i <= $totalQuestions; $i++)
                                @php
                                    ...
                                    if ($questions->currentPage() == $i) {
                                        $buttonClass = 'bg-gradient-to-r from-[#3A6EA5] to-[#4A7EBA] text-white ring-4 ring-[#3A6EA5]/30 shadow-lg transform scale-110';
                                    } elseif ($isMarked) {
                                        $buttonClass = 'bg-gradient-to-r from-yellow-100 to-yellow-200 border-2 border-yellow-400 text-yellow-800 hover:from-yellow-200 hover:to-yellow-300 shadow-md';
                                    } elseif ($hasAnswer) {
                                        $buttonClass = 'bg-gradient-to-r from-[#90BE6D] to-[#7FA85C] hover:from-[#7FA85C] hover:to-[#6EA049] text-white shadow-md transform hover:scale-105';
                                    } else {
                                        $buttonClass = 'bg-gradient-to-r from-gray-100 to-gray-200 hover:from-[#3A6EA5]/10 hover:to-[#90BE6D]/10 text-gray-700 hover:text-[#3A6EA5] border-2 border-gray-300 hover:border-[#3A6EA5]/30 hover:shadow-md transform hover:scale-105';
                                    }
                                @endphp
                                <a href="{{ route('asesi.sertifikasi.level.a.show', ['exam' => $exam, 'page' => $i]) }}"
                                   ...
                                   title="Soal {{ $i }}{{ $hasAnswer ? ' (Sudah dijawab)' : ' (Belum dijawab)' }}">
                                    {{ $i }}
                                    @if ($isMarked)
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 absolute -top-1 -right-1" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-gradient-to-r from-[#3A6EA5]/5 to-[#90BE6D]/5 px-6 py-5 border-t border-[#3A6EA5]/20">
                        <div class="grid grid-cols-3 gap-4 text-center">
                            <div class="bg-white p-4 rounded-xl shadow-lg border-2 border-[#3A6EA5]/20 transform hover:scale-105 transition-transform duration-200">
                            ...
                            <div class="bg-white p-4 rounded-xl shadow-lg border-2 border-[#90BE6D]/20 transform hover:scale-105 transition-transform duration-200">
                            ...
                            <div class="bg-white p-4 rounded-xl shadow-lg border-2 border-red-200 transform hover:scale-105 transition-transform duration-200">
                                <div class="text-xs text-gray-500 font-medium mb-1">Belum</div>
                                <div class="text-2xl font-bold text-red-600">{{ $totalQuestions - $answeredQuestions }}</div>
                            </div>
                        </div>
        ...
        <script>
            ...
            document.querySelectorAll('a[href*="page="]').forEach(function(link) {
                link.addEventListener('click', function(e) {
                    ...
                    this.innerHTML = '<div class="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>';
                });
            });
            ...
            document.querySelectorAll('img[onclick*="window.open"]').forEach(function(img) {
                img.addEventListener('click', function(e) {
                    ...
                    closeBtn.innerHTML = '×';
                    closeBtn.className = 'absolute -top-4 -right-4 bg-white text-black rounded-full w-10 h-10 flex items-center justify-center text-2xl font-bold shadow-lg hover:bg-gray-100 transition-colors';
