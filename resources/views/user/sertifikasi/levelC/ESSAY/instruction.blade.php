...
@section('content')
    <div class="min-h-screen bg-slate-50 font-sans text-slate-800">
        <div class="container mx-auto max-w-5xl p-3 py-6 sm:p-4 sm:py-8 lg:p-12">
            ...
            {{-- Header Section --}}
            <div class="mb-6 rounded-xl bg-gradient-to-br from-indigo-700 to-indigo-800 p-4 text-white shadow-xl sm:mb-8 sm:rounded-2xl sm:p-6 md:p-8">
            ...
            <div class="mb-6 grid grid-cols-1 gap-3 sm:mb-8 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4 lg:gap-6">
                <div class="flex items-center space-x-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:space-x-4 sm:rounded-2xl sm:p-5">
                    <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-700 sm:h-12 sm:w-12">
            ...
            <div class="mb-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:mb-8 sm:rounded-2xl sm:p-6 md:p-8">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
                    <div>
                        <h3 class="mb-3 border-l-4 border-indigo-600 pl-3 text-sm font-semibold text-slate-800 sm:text-base">Format Jawaban</h3>
                        <ul class="space-y-2 text-xs text-slate-700 sm:space-y-3 sm:text-sm">
                            <li class="flex items-start">
                                <svg class="mr-2 mt-0.5 h-3 w-3 flex-shrink-0 text-indigo-600 sm:mr-3 sm:mt-1 sm:h-4 sm:w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" /></svg>
                ...
                <div class="mt-6 rounded-lg border-l-4 border-indigo-500 bg-indigo-50 p-3 sm:mt-8 sm:p-4">
                    <div class="flex">
                        <div class="flex-shrink-0">
                            <svg class="h-4 w-4 text-indigo-600 sm:h-5 sm:w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <div class="ml-2 sm:ml-3">
                            <p class="text-xs text-indigo-800 sm:text-sm">
                                <span class="font-semibold">Tips:</span> Baca setiap pertanyaan dengan teliti, buat kerangka jawaban terlebih dahulu, dan jawab secara sistematis dengan memberikan contoh nyata dari pengalaman mengajar Anda.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:rounded-2xl sm:p-6 md:p-8">
                <div class="text-center">
                    ...
                    <p class="mb-4 text-xs text-slate-600 sm:mb-6 sm:text-sm">Pastikan Anda telah memahami semua petunjuk sebelum memulai pengerjaan essay.</p>
