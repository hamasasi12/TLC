<div id="asesiTableSection" class="bg-white rounded-xl shadow-md p-6 lg:col-span-2">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.asesi.index') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">Lihat Semua</a>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 whitespace-nowrap">
                        ...
                        <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">Laki Laki</span>
                        @else
                        <span class="px-2 py-1 text-xs font-medium bg-red-100 text-red-800 rounded-full">Perempuan</span>
                        @endif
                    </td>
